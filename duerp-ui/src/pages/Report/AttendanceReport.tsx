...
//
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24">
            <PageMeta
                title="Create New Class | Attendance Management System"
                description="Create and schedule new classes for your attendance management system"
            />
                                ...
                                <div>
                                    ...
                                    <div className="gap-2">
                                        <div className="grid grid-cols-3">
                                            <div>Day Name</div>
                                            <div>Start Time</div>
                             AttendaceReport               <div>End Time</div>
                                        </div>
                                        {days.map((day) => (
                                            <div className="grid grid-cols-3">
                                                <div>
