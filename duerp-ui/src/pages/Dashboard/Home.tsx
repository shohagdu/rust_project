...
const Home: React.FC = () => {
    ...
    const handleManageStudents = (operation: ClassOperation) => {
        navigate(`/show-course-operation/${operation.id}`, {
            state: { operation },
        });
    };
    ...
    if (loading) {
        return (
            <div>
                <PageMeta
                    title="Attendance Management System | University of Dhaka | Loading..."
    ...
    return (
        <div>
            <PageMeta
                title="Attendance Management System | University of Dhaka"
                description="Attendance Management System | University of Dhaka"
            />
                            ...
                            return (
                                ...
                                >
                                    <div className="p-6">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 cursor-pointer"
                                        ...
                                        <div className="flex items-center text-gray-600 dark:text-gray-400 mb-4">
                                            {
                                                op.course_year || op.course_semester || op.course_section ? (
                                                    <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <span className="text-sm">
                                                {
                                                    [
                                                        yearLookup[op.course_year],
                                                        semesterLookup[op.course_semester],
                                                    ]
                                                        .filter(Boolean)
                                                        .join(" - ")}

                                                {sectionLookup[op.course_section] &&
                                                    (yearLookup[op.course_year] || semesterLookup[op.course_semester])
                                                    ? `: ${sectionLookup[op.course_section]}`
                                                    : sectionLookup[op.course_section] || ""
                                                }
                                            </span>
